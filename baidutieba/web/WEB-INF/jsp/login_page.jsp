...
<div class="center-in-center wrapper">
    <form class="form-signin" action="/one">
        <h2 class="shuiping_juzhong form-signin-heading">Please login</h2>
        <input type="text" class="form-control" name="name" placeholder="User name" required="" autofocus=""/>
        <input type="text" class="form-control" name="money"  placeholder="Password" required=""/>
        <button style="margin-top: 20px" class="btn btn-primary btn-lg btn-block" type="submit">Login</button>
    </form>
</div>
</body>
</html>
