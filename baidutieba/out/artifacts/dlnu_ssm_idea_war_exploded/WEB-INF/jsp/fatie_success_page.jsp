...
<body>
<div class="wrapper center-in-center">
<h2 class="shuiping_juzhong">成功</h2>
<form class="form-signin" action="/listfatie">
    <input type="hidden" value="${flag1}" name="flag1" >
    <input type="hidden" value="${name}" name="flag2" >
    <input class="btn btn-lg btn-primary btn-block" type="submit" value="点此跳转">
</form>
</div>
