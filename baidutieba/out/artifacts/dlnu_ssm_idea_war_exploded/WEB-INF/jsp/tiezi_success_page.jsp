...
<p class="shuiping_juzhong">回帖成功</p>
<form class="form-signin" action="/listtiezi">
    ...
    <button class="btn btn-lg btn-primary btn-block" type="submit">点此进入原帖子</button>
</form>
</div>
